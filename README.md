...
<img src="https://github.com/agodoi/SubRedes/blob/main/imgs/network-topology.png" width="400">
...
#### (4.16) Agora vamos pegar alguns dados da sua rede física
...
Tome nota do seu IP local. Deve começar com 192.168...

#### (4.17) Agora, vamos fazer um simples teste de carga usando o protocolo ICMP - Internet Control Message Protocol. Abra um terminal CMD e ping o seu gateway, isto é, o IP do roteador que você está conectado. Substitua o X pelo valor que você leu no seu comando anterior.

Windows
```
ping 192.168.X.1 -l 1400 -n 200
```

Linux
```
ping 192.168.X.1 -s 1400 -c 200
```

#### (4.18) Verifique o comportamento do TEMPO. Ele está variando muito? Está alto? Está baixo? Quantos hosts tem na rede fazendo testes?

#### (4.19) Agora vamos tentar encontrar o pior cabo da sala... O pior vai ganhar um chocolate

<img src="https://github.com/agodoi/m09cc-semana02/blob/main/assets/pimentinha.png" width="300">

#### (4.20) Todos os pares desplugam o seu cabo do switch, e por ordem, cada dupla pluga na mesma porta 1 do switch e executa um ping para o roteador que você está conectado diretamente:

Windows
```
ping 192.168.X.1 -l 10000 -n 10
```

Linux
```
ping 192.168.X.1 -s 10000 -c 10
```

#### e diga ao professor os 3 maiores valores de tempo. Se der um pacote "tempo esgotado", a dupla já saiu na frente.

#### (4.21) Vamos mapear nossa rede. Todos dêem esse comando:
...
#### (4.22) Vamos descobrir os IP que você já conversou nesta rede.
...
#### (4.23) Vamos conferir qual largura de banda você está conectado. Seu cabo está em 100Mbps ou 1Gbps? No terminal, digite:
